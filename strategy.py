...
class Binongtot(object):
    ...
    def fractals_strategy(self, ctr, merge_ws_dataonline, count_lencur, wsdata):
        ...
        set_time_put = (2 if is_upper_bb == True else 3)

        set_time_cci_call = (2 if is_upper_bb == True else 1)
        set_time_cci_put = (2 if is_upper_bb == True else 2)
        ...
        if ctr % 5:
            ...
            if fhi == True and curr_price < hh1:
            ...
            if flo == True and curr_price > ll1:
                msg = "⬆ [[{}]] [[WS]] [[FRACTALS-DOWN]] potentially BUY [[23011]] - UTC7 {} | UTC0 {}".format(self.currency, str(timesx), str(timesx_utc))                
                if (msg != self.msg_buy) and (self.lasttime != str(timesx)):
            ...
            if len(self.val_resistance) > 0 and len(self.val_support) > 0:
                ...
                is_fhi_below_ema8 = get_fhi_price < ema8 
                is_flo_below_ema8 = get_flo_price < ema8
                print("val_support -> ", val_support)
                print("val_resistance -> ", val_resistance)
                print("get_fhi_price -> ", get_fhi_price)
                print("get_flo_price -> ", get_flo_price)
                print("is_fhi_below_ema8 -> ", is_fhi_below_ema8)
                print("is_flo_below_ema8 -> ", is_flo_below_ema8)
